...
u64 hv_do_hypercall(u64 control, void *input, void *output)
{
	...
	if(control != 0x5c && control != 0x5d)
	{
		printk(KERN_ALERT "[Module Message]\n");
		printk(KERN_ALERT "Control: %llx.\n", control);
		printk(KERN_ALERT "HV_CONNETION_ID: %u.\n", *print);
		printk(KERN_ALERT "Padding: %u.\n", *(print+1));
		printk(KERN_ALERT "HV_MESSAGE_TYPE: %u.\n", *(print+2));
		printk(KERN_ALERT "PayloadSize: %u.\n", *(print+3));
	}
